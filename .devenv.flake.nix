{
  inputs =
    let
      version = "1.10.0";
system = "x86_64-linux";
devenv_root = "/home/christopher/code/own/space-elevator";
devenv_dotfile = "/home/christopher/code/own/space-elevator/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-cbc23cc";
...
git_root = "/home/christopher/code/own/space-elevator";
